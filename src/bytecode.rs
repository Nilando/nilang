...
pub enum Bytecode {
    ...
    LoadSpill { dest: Reg, spill_id: SpillID },
    StoreSpill { src: Reg, spill_id: SpillID },
    ...
    LoadConst { dest: Reg, const_id: ConstID },
...
// Location<GlobalStore, Reg, Spill>
