...
impl<'a> TacGenCtx<'a> {
    ...
    fn generate_key_store(&mut self, store: Var, key: Var, src: Var, span: Span) {
        let mem = MemoryLocation::new(store, key);
        self.emit_spanned(
            Tac::MemStore {
                mem, 
                src
    ...
    fn index_assignment_tac() {
        let tac = vec![
            vec![
                ...
                Tac::MemStore { src: Var::temp(3), mem: MemoryLocation::new(Var::temp(2), Var::temp(4)) }, 
                Tac::LoadConst { dest: Var::temp(5), src: TacConst::Int(0) },
                Tac::MemStore { src: Var::temp(1), mem: MemoryLocation::new(Var::temp(2), Var::temp(5)) }, 
            ]
        ];
        let input = "[1][0] = 1;";
    ...
    fn access_assignment_tac() {
        ...
        let tac = vec![
            vec![
                ...
                Tac::MemStore { src: Var::temp(1), mem: MemoryLocation::new(Var::local(syms.get_id("a")), Var::temp(2)) }, 
            ]
        ];
        let input = "a.b = 1;";
    ...
    fn sym_key_load() {
        ...
        let tac = vec![
            vec![
              ...
              Tac::MemLoad { dest: Var::local(syms.get_id("a")), mem: MemoryLocation::new(Var::local(syms.get_id("b")), Var::temp(1)) }, 
            ]
        ];
        let input = "a = b.c;";
    ...
    fn map_assignment() {
        ...
        let tac = vec![
            vec![
              ...
              Tac::MemStore { mem: MemoryLocation::new(Var::temp(1), Var::temp(2)), src: Var::temp(3) },
